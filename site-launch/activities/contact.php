...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$name || !$phone || !$email || !$charterDate || !$message) {
        ...
        $body = "You received a new activity inquiry:\n\n"
              . "Activity: " . ($boat ?: "Not provided") . "\n"
              . "Name: $name\n"
              . "Phone: $phone\n"
        ...
        $headers = "From: Activity Page <no-reply@flamingoyachtcharters.com>\r\n";
...
<div class="card">
    ...
    <?php if ($pageUrl): ?>
        <a class="back-link" href="<?php echo escape($pageUrl); ?>#contact-form">Back to activity page</a>
    <?php endif; ?>
</div>
